    ...
    return (
        <div className="p-4 flex items-center justify-between text-gray-500">
            ...
            <div className="flex items-center justify-between text-sm">
                <button className="px-2 text-sm rounded-sm bg-lamaSky">1</button>
                <button className="px-2 text-sm rounded-sm ">2</button>
                <button className="px-2 text-sm rounded-sm ">3</button>
                ...
                <button className="px-2 text-sm rounded-sm ">3</button>
            </div>
